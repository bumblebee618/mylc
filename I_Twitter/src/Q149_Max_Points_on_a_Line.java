...
public class Q149_Max_Points_on_a_Line {
	...
	// solution 1:
	public int maxPoints(Point1[] points) {
        ...
        for(int i = 0; i < n; i++){
            ...
            for(int j = i + 1; j < n; j++){               
                ...
                Map<Integer, Integer> map_y = map.get(x);
                map_y.put(y, map_y.getOrDefault(y, 1) + 1);
                map.put(x, map_y);
                localMax = Math.max(localMax, map_y.get(y));
            }
	...
	// solution 2:
	public int maxPoints2(Point1[] points) {
		if(points == null || points.length == 0){
            return 0;
        } else if(points.length <= 2){
            return points.length;
	...
	public int maxPoints3(Point1[] points) {
		if(points == null || points.length == 0) {
			return 0;
		}
	...
	public static void main(String[] args){
		...
		Point1[] points = new Point1[3];
		points[0] = new Point1(0, 0);
		points[1] = new Point1(94911151, 94911150);
		points[2] = new Point1(94911152, 94911151);
