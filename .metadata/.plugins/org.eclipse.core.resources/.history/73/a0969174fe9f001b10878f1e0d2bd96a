...
public class Q000_A_Contest 
{
	...
	private int getXorResult(int num, int andResult)
	{
		int xorResult = 0;
		int index = 0;
		
		while (num != 0 && andResult != 0)
		{
			int digit1 = (num & 1);
			int digit2 = (andResult & 1);
			
			xorResult |= ((digit1 ^ digit2) << index);
			index++;
    ...
    public static void main(String[] args)
    {
    	...
    	System.out.println(test.getXORSum(arr11, arr12));
    	System.out.println(test.getXORSum(arr21, arr22));
    }
}
