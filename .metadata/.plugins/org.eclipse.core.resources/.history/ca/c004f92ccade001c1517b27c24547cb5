...
S was sorted in some custom order previously. We want to permute the characters of T so that they match the order that S was sorted. More specifically, if row occurs before col in S, then row should occur before col in the returned string.
