...
The whole input represents a binary tree. It contains an integer followed by zero, one or two pairs of parenthesis. The integer represents the root's minValue and a pair of parenthesis contains a child binary tree with the same structure.
