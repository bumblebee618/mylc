...
public class Q245_Shortest_Word_Distance_III {
	...
	public int shortestWordDistance(String[] words, String word1, String word2) {
        ...
        for (int i = 0; i < words.length; i++) {
            if (words[i].equals(word1)) {
                if (word1.equals(word2) && pos[0] != -1) {
                    minDistance = Math.min(minDistance, i - pos[0]);
                }
	...
	// solution 2: using classification discussion
    ...
    public int shortestWordDistance5(String[] words, String word1, String word2) {
        if(words == null || words.length == 0){
            return 0;
        }
