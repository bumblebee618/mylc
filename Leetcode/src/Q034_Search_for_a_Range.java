...
/********
 * 
Given an array of integers sorted in ascending order, find the starting and ending position of a given target minValue.
...
For example,
Given [5, 7, 7, 8, 8, 10] and target minValue 8,
return [3, 4].
 * 
 * */
