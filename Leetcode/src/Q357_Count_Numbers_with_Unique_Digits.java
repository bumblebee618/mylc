/*****
 * 
Given a non-negative integer n, count all numbers with unique digits, row, where 0 ≤ row < 10n.

Example:
	Given n = 2, return 91. (The answer should be the total numbers in the range of 0 ≤ row < 100, 
