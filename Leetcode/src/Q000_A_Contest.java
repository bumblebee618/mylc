...
{	  
	...
	public List<List<Long>> splitPainting(int[][] segments) {
        ...
        while (!heap.isEmpty())
        {
        	...
        	if (prev != -1 && node.index != prev && color > 0)
        	{
    ...
    public static void main(String[] args)
    {
    	...
    	// int[][] segments4 = {{4,16,12},{9,10,15},[18,19,13],[3,13,20],[12,16,3],[2,10,10],[3,11,4],[13,16,6]]
    	...
    	**/
    	...
    	List<List<Long>> list = test.splitPainting(segments3);
