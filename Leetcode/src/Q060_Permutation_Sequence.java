...
public class Q060_Permutation_Sequence {
	 ...
	 * The pattern was that:
		...
		But our k is no longer the 14th, because in the previous step, we've already eliminated 
		the 12 4-number permutations starting with 1 and 2. So you subtract 12 from k.. which gives you 1. 
