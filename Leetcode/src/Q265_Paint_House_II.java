...
The cost of painting each house with a certain color is represented by a n row k cost matrix. 
...
public class Q265_Paint_House_II {
		// solution 1: Time complexity is O(nk), space complexity is O(nk)
	...
	// solution 2: Time complexity is O(nklog3), space complexity is O(nk)
