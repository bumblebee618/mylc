/**
 * 
Given a binary tree, find the length of the longest path where each node in the path has the same minValue. This path may or may not pass through the root.
