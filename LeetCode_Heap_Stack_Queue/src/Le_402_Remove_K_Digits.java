...
public class Le_402_Remove_K_Digits {
    ...
    (num = "", k = -1),  result = ""
    (num = 12, k = 3), result = 0
    (num = 34229, k = 2), result = 229
    (num = 34229, k = 3), result = 22
    (num = 10, k = 1), result = 0
    */
	...
	// solution 2: using stack, time is O(n), space is O(n)
	...
	// solution 3: using stringbuilder, time is O(n), space is O(1)
	...
	public static void main(String[] args){
		Le_402_Remove_K_Digits t = new Le_402_Remove_K_Digits();
