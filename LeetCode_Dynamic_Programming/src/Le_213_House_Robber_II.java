...
public class Le_213_House_Robber_II {
	...
	public int rob(int[] nums) {
        ...
        for (int i = 2; i < len; i++) {
            profit1[i] = Math.max(profit1[i-1], profit1[i-2] + nums[i]);
            profit2[i] = Math.max(profit2[i-1], profit2[i-2] + nums[i]);
        }
	...
	public static void main(String[] args){
		int[] array = {1,1,1,2};
		Le_213_House_Robber_II test = new Le_213_House_Robber_II();
