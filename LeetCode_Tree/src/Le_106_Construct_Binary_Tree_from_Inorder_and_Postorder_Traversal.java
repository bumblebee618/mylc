...
public class Le_106_Construct_Binary_Tree_from_Inorder_and_Postorder_Traversal {
    ...
    public static void main(String[] args){
    	Le_106_Construct_Binary_Tree_from_Inorder_and_Postorder_Traversal t = new Le_106_Construct_Binary_Tree_from_Inorder_and_Postorder_Traversal();
